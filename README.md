...
2. Builds **Maestro** and **Sinfonia** Docker images from `apps/*/Dockerfile` (Sinfonia clients build in parallel; npm/OpenCV layers cache unless `package.json` changes)
